                ...
                case 5:
                    pubsub_js_1.default.subscribe(id, function (msg, data) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    if (!data.success) return [3 /*break*/, 10];
                                    if (!data.headers) return [3 /*break*/, 9];
                                    finalHeaders = {};
                                    _a = [];
                                ...
                                case 1:
                                    ...
                                    if (!(header === "Set-Cookie" &&
                                        ...
                                        Array.isArray(data.headers["Set-Cookie"]))) return [3 /*break*/, 6];
                                    if (!options.cookieJar) return [3 /*break*/, 5];
                    ...
                    main_1.BACKEND.send(JSON.stringify(request));
                    /**
